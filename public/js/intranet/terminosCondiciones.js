$(document).ready(function () {
    listarMenus(function (lstModulos, lstMenus) {
        let vueTerminosCondiciones = new Vue({
            el: '#wrapper',
            data: {
            ...
            methods: {
                ...
                ajaxListar: function (onSuccess) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/terminos-condiciones/ajax/listar',
                ...
                ajaxActualizarImagenPortada: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/terminos-condiciones/ajax/actualizarImagenPortada',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoEspanol: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/terminos-condiciones/ajax/actualizarContenidoEspanol',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoIngles: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/terminos-condiciones/ajax/actualizarContenidoIngles',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
