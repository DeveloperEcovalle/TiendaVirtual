        ...
        let vueGuia = new Vue({
            ...
            methods: {
                ...
                ajaxListar: function (onSuccess) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/guia-compras/ajax/listar',
                ...
                ajaxActualizarImagenPortada: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/guia-compras/ajax/actualizarImagenPortada',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoEspanol: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/guia-compras/ajax/actualizarContenidoEspanol',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoIngles: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/guia-compras/ajax/actualizarContenidoIngles',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
