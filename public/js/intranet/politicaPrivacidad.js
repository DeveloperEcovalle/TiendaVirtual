        ...
        let vuePoliticaPrivacidad = new Vue({
            ...
            methods: {
                ...
                ajaxListar: function (onSuccess) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/politica-privacidad/ajax/listar',
                ...
                ajaxActualizarImagenPortada: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/politica-privacidad/ajax/actualizarImagenPortada',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoEspanol: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/politica-privacidad/ajax/actualizarContenidoEspanol',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoIngles: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/politica-privacidad/ajax/actualizarContenidoIngles',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
