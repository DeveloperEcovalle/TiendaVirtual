        ...
        let vueTienda = new Vue({
            ...
            methods: {
                ...
                ajaxListar: function (onSuccess) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/tienda/ajax/listar',
                ...
                ajaxActualizarImagenPortada: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/tienda/ajax/actualizarImagenPortada',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarBaner: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/tienda/ajax/actualizarBaner',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoEspanol: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/tienda/ajax/actualizarContenidoEspanol',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoIngles: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/tienda/ajax/actualizarContenidoIngles',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
