        ...
        let vueCertificaciones = new Vue({
            ...
            methods: {
                ...
                ajaxActualizarImagenPortada: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/certificaciones/ajax/actualizarImagenPortada',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoEspanol: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/certificaciones/ajax/actualizarContenidoEspanol',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoIngles: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/certificaciones/ajax/actualizarContenidoIngles',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
