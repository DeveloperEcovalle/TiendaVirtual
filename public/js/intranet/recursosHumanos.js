        ...
        let vueServicios = new Vue({
            ...
            methods: {
                ...
                ajaxListar: function (onSuccess) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/recursos-humanos/ajax/listar',
                ...
                ajaxActualizarImagenPortada: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/recursos-humanos/ajax/actualizarImagenPortada',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoEspanol: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/recursos-humanos/ajax/actualizarContenidoEspanol',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                ajaxActualizarContenidoIngles: function () {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '/intranet/app/pagina-web/recursos-humanos/ajax/actualizarContenidoIngles',
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
