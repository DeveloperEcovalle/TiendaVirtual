...
@section('title', 'PRECIOS DE ENVIO')
            ...
            <div class="border-bottom border-right d-flex white-bg">
                <div class="col-8 py-3">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item d-none d-md-block">
                            <a>Gesti&oacute; de inventario</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <strong>Precios de env&iacute;o</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-4">
            ...
            <div class="p-4" id="layoutLeft">
                <table class="table table-bordered table-hover" id="tblUsuarios">
                    ...
                    <tr>
                        ...
                        <th class="bg-primary text-right">Precio</th>
                    </tr>
                    </thead>
                    <tbody class="bg-white">
                    <tr v-for="precioEnvio of lstPreciosEnvio" v-bind:class="{selected: iIdSeleccionado === precioEnvio.id}" v-on:click="panelEditar(precioEnvio.id)" style="cursor: pointer;" v-cloak>
                        <td class="text-center">@{{ precioEnvio.id }}</td>
                        <td>@{{ precioEnvio.departamento }}</td>
                        <td>@{{ precioEnvio.provincia }}</td>
                        <td>@{{ precioEnvio.distrito }}</td>
                        <td class="text-right">S/ @{{ precioEnvio.precio.toFixed(2) }}</td>
                    </tr>
...
@section('js')
    <script src="/js/intranet/preciosEnvio.js?cvcn=14"></script>
@endsection
