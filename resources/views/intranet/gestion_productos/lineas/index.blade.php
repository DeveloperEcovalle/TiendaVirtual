...
@section('title', 'LÍNEAS DE PRODUCTOS')
                ...
                <div class="col-8 py-3">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>L&iacute;neas de productos</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-4">
            ...
            <div class="p-4" id="layoutLeft">
                <table class="table table-bordered table-hover" id="tblCategorias">
                    ...
                    <tbody class="bg-white">
                        <tr v-for="linea of lstLineas" v-bind:class="{selected: iIdSeleccionado === linea.id}" v-on:click="panelEditar(linea.id)" style="cursor: pointer;" v-cloak>
                            <td>@{{ linea.nombre_espanol }}</td>
                        </tr>
                        <tr v-if="lstLineas.length === 0" v-cloak>
...
@section('js')
    <script src="/js/intranet/lineasProductos.js?cvcn=14"></script>
@endsection
