    ...
    <div class="row m-0" v-if="iError === 0">
        <div class="col-12 col-md-8 p-0">
                ...
                <div class="col-8 py-3">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Categor&iacute;as de productos</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-4">
            ...
            <div class="p-4" id="layoutLeft">
                <table class="table table-bordered table-hover" id="tblCategorias">
                    <thead>
                        <tr>
                            <th class="bg-primary">Nombre</th>
                            <th class="bg-primary text-center">Imagen</th>
                            <th class="bg-primary text-center">Imagen de selecci&oacute;n</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white">
                        <tr v-for="categoria of lstCategorias" v-bind:class="{selected: iIdSeleccionado === categoria.id}" v-on:click="panelEditar(categoria.id)" style="cursor: pointer;" v-cloak>
                            <td>@{{ categoria.nombre_es }}</td>
                            <td class="text-center">
                                <img :src="categoria.ruta_imagen" style="width: 40px">
                            </td>
                            <td class="text-center">
                                <img :src="categoria.ruta_imagen_hover" style="width: 40px">
                            </td>
                        </tr>
                        <tr v-if="lstCategorias.length === 0" v-cloak>
...
@section('js')
    <script src="/js/intranet/categoriasProductos.js?cvcn=14"></script>
@endsection
