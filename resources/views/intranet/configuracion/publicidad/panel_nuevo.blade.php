<div class="d-flex border-bottom white-bg">
    <div class="col-12 p-3 font-bold">Nueva Publicidad</div>
</div>
<div class="d-flex p-4 bg-white border-top" id="layoutRight">
    <form role="form" v-on:submit.prevent="ajaxInsertar" class="w-100" id="frmNuevo">
        ...
        <div class="form-group">
            ...
            <small>Ingresa aqu&eacute; direcci&oacute;n quieres que te lleve este banner al hacer click en &eacute;l.</small>
        </div>
        <div class="row">
