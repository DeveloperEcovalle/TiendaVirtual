...
class Servicios extends Intranet {
    ...
    public function init() {
        ...
        $this->iModuloId = 20;
        $this->iMenuId = 23;
        $this->sPermisoListar = 'PWEBSERVLISTAR';
        $this->sPermisoActualizar = 'PWEBSERVACTUALIZAR';
    }
    ...
    public function index($iIdInterno = 0) {
        ...
        return view('intranet.paginaweb.servicios.index', $data);
    }
