...
class Tienda extends Intranet {
    ...
    public function init() {
        ...
        $this->iModuloId = 20;
        $this->iMenuId = 41;
        $this->sPermisoListar = 'PWEBTIENDALISTAR';
        $this->sPermisoActualizar = 'PWEBTIENDAACTUALIZAR';
    }
    ...
    public function index($iIdInterno = 0) {
        ...
        return view('intranet.paginaweb.tienda.index', $data);
    }
