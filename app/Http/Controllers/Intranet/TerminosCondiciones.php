...
class TerminosCondiciones extends Intranet {
    ...
    public function init() {
        ...
        $this->iModuloId = 20;
        $this->iMenuId = 37;
        $this->sPermisoListar = 'PWEBTERMCONDLISTAR';
        $this->sPermisoActualizar = 'PWEBTERMCONDACTUALIZAR';
    }
    ...
    public function index($iIdInterno = 0) {
        ...
        return view('intranet.paginaweb.terminos_condiciones.index', $data);
    }
