...
class Certificaciones extends Intranet {
    ...
    public function init() {
        ...
        $this->iModuloId = 20;
        $this->iMenuId = 33;
        $this->sPermisoListar = 'PWEBCERTIFLISTAR';
        $this->sPermisoActualizar = 'PWEBCERTIFACTUALIZAR';
    }
    ...
    public function index($iIdInterno = 0) {
        ...
        return view('intranet.paginaweb.certificaciones.index2', $data);
    }
