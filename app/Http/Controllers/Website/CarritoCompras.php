...
class CarritoCompras extends Website {

    protected $lstTraduccionesCarritoCompras;

    public function __construct() {
        parent::__construct();

        $this->lstTraduccionesCarritoCompras = [
            'en' => [
    ...
    public function index(Request $request) {
        ...
        $data = [
            ...
            'lstTraduccionesCarritoCompras' => $this->lstTraduccionesCarritoCompras[$locale],
            'iPagina' => -1,
            'empresa' => $empresa,
            'telefono_whatsapp' => TelefonoEmpresa::where('whatsapp', 1)->first(),
        ];

        return view('website.carrito_compras_2', $data);
    }
